...
\begin{enumerate}
    ...
    \item \textbf{faces} category has resolution of 178x218, \textbf{nature} category has resolution of 512x512, and \textbf{nature} category resolutions varies as Figures \ref{fig:width_and_height} and \ref{fig:aspect_distribution} demonstrate. Figure \ref{fig:aspect_distribution} shows that most of the images have aspect retio 1-2. Images with ration more than 6 were removed as extreme cases (in total 24 of them).
